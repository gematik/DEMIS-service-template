...
COPY --chown=$USERID:$GROUPID target/service-demo.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="DEMIS SpringBoot Service Demo" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/git/demis/springboot-service-template" \
